...
export const metadata = {
  ...
  description:
    "Dumpster Rescue LLC is a local family business serving Chicagoland with professional junk removal, demolition, and dumpster rental. Based in Bartlett, IL.",
  alternates: {
    canonical: "/about/"
  }
};
    ...
    <div className="bg-white">
      ...
      <section className="bg-black">
        <div className="mx-auto w-full max-w-6xl px-6 py-16">
          ...
          <h1 className="mt-2 font-heading text-4xl font-bold uppercase text-white md:text-5xl">
      ...
      <div className="mx-auto w-full max-w-6xl px-6 pb-16 pt-10">
        ...
        <section className="flex flex-col gap-8 md:flex-row md:items-center">
          <div className="flex-1">
            ...
            <p className="mt-4 text-sm text-gray-700">
              We started Dumpster Rescue LLC because we saw a gap in the market.
          ...
          <div className="w-full md:w-96">
            <div className="overflow-hidden rounded-lg border border-gray-200 shadow-lg">
              <img
                ...
                alt="Dumpster Rescue LLC team - local Bartlett junk removal crew"
        ...
        {/* Local Roots Section */}
        <section className="mt-16 rounded-lg border border-gray-200 bg-gray-50 p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-900">
        ...
        <section className="mt-16">
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-lg">
              <p className="text-3xl font-bold text-red-600">5+</p>
              <p className="mt-1 text-sm text-gray-600">Years Serving DuPage County</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-lg">
              <p className="text-3xl font-bold text-red-600">64</p>
        ...
        {/* Final CTA Section */}
        <section className="mt-16 rounded-lg bg-black p-8 text-center shadow-lg md:p-12">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              ...
              className="w-full rounded-lg bg-red-600 px-8 py-4 text-sm font-bold uppercase tracking-wide text-white shadow-lg hover:bg-red-700 sm:w-auto"
            >
              Call {brand.phone}
            </a>
            <a
              href={brand.smsHref}
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-8 py-4 text-sm font-bold uppercase tracking-wide text-white shadow-lg hover:bg-blue-700 sm:w-auto"
            >
        ...
        <section className="mt-16">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link href="/services/junk-removal/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              Junk Removal
            </Link>
            <Link href="/services/demolition/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              Demolition
            </Link>
            <Link href="/services/dumpster-rental/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              Dumpster Rental
            </Link>
            <Link href="/services/estate-cleanout/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              Estate Cleanout
            </Link>
            <Link href="/services/garage-cleanout/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              Garage Cleanout
            </Link>
            <Link href="/locations/" className="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-800 hover:bg-gray-50">
              All Locations
            </Link>
          </div>
        </section>
