...
export const metadata = {
  ...
  description:
    "Call, text photos, or fill out our form. Same-day junk removal available. Dumpster Rescue LLC serves DuPage, Kane, and Cook counties from Bartlett, IL.",
  alternates: {
    canonical: "/contact/"
  }
};
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-lg">
              ...
              <a
                ...
                className="mt-4 block w-full rounded-lg bg-red-600 px-6 py-4 text-center text-sm font-bold uppercase tracking-wide text-white shadow-lg hover:bg-red-700"
              >
                Call {brand.phone}
              </a>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-lg">
              ...
              <a
                href={brand.smsHref}
                className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-600 px-6 py-4 text-sm font-bold uppercase tracking-wide text-white shadow-lg hover:bg-blue-700"
              >
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-lg">
              ...
              <a
                href="#quote-form"
                className="mt-4 block w-full rounded-lg border border-gray-300 bg-white px-6 py-4 text-center text-sm font-bold uppercase tracking-wide text-gray-700 shadow hover:bg-gray-50"
              >
                Jump to Form
              </a>
            </div>
