      ...
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-green-600 px-8 py-4 text-base font-bold uppercase tracking-wide text-white shadow-lg hover:bg-green-700 sm:w-auto"
          >
          ...
          <a
            href={brand.smsHref}
            className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-gray-900 bg-transparent px-8 py-4 text-base font-bold uppercase tracking-wide text-gray-900 hover:bg-gray-100 sm:w-auto"
          >
            <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
